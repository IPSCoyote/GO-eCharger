...
`Ladeende nach x kw (0kw = deaktiviert)` | Float | Ladung nach abgabe von X kw beenden<br>0 = kein automatischer Ladestop | [Get](#41281-getautomaticchargestopint-instanz) / [Set](#41282-setautomaticchargestopint-instanz-float-kw)
`Ladeende nach Energie für x km (0km = deaktiviert)` | Integer | Ladung nach Abgabe von Energie für X Kilomenter beenden<br>0 = kein automatischer Ladestop | Nein
`LED Helligkeit`
