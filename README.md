...
`Ladeende nach Energie für x km (0km = deaktiviert)` | Integer | RW, WF | Ladung nach Abgabe von Energie für X Kilomenter beenden<br>0 = kein automatischer Ladestop | Nein
`LED Helligkeit`
